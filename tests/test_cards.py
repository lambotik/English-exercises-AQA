...
class TestChapter1:
    @allure.sub_suite('Test Prepositions Of Time Page.')
    ...
    @allure.sub_suite('In/on time, at/in the end/beginning.')
    ...
    @allure.sub_suite('To/at/in/into.')
    ...
    @allure.sub_suite('Usage of "by" preposition.')
    ...
    @allure.sub_suite('Prepositions with nouns.')
    ...
    @allure.sub_suite('Prepositions with adjectives.')
    ...
    @allure.sub_suite('Prepositions with adjectives 2.')
    ...
    @allure.sub_suite('Prepositions with verbs.')
    ...
    @allure.sub_suite('Prepositions with verbs (p2).')
    ...
    @allure.sub_suite('Prepositions with verbs (p3).')
    ...
    @allure.sub_suite('Prepositions with verbs (p4).')
    ...
    @allure.sub_suite('Prepositions with verbs (p5).')
